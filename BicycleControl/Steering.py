...
class Steering:
	...
	def initDynamixel(self):
		...
		dynamixel.write1ByteTxRx(self.port_num, self.PROTOCOL_VERSION, self.DXL_ID, self.ADDR_MX_TORQUE_ENABLE, self.TORQUE_ENABLE)
	...
	def _init_(self):
		...
		#somehow doesnt get executed
		#initDynamixel()
		
	#maps steering angle to motor value
	def mapTargetAngleToMotorValue(self, targetAngle):
	
		#at value 2000 the wheel is centered
		#at value 101 the wheel is at -90 degrees
		#
		self.mappedSteerAngle = 2000 + (21.1) * targetAngle
	
		#TODO: map motorValue correctly
		#if targetAngle > 0:
		#	self.mappedSteerAngle = 2047 + 250
		#elif targetAngle < 0:
		#	self.mappedSteerAngle = 2047 - 250
		#else:
		#	self.mappedSteerAngle = 2047
	...
	def setAngle(self, steerAngle):
		...
		print("Angle: " + str(steerAngle) + " mappedValue: " + str(self.mappedSteerAngle))
